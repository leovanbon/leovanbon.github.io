...
After it put the encrypted test flag into `flag.txt.emilia`, the PE creates a `.cab` with the name fields and timestamp in the filename, which contains that same `.emilia` file.
